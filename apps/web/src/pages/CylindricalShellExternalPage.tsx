...
import { CylindricalShellExternalCalculator } from "@/components/calculators/CylindricalShellExternalCalculator";
import { Skeleton } from "@/components/ui/skeleton";

export function CylindricalShellExternalPage() {
  ...
  return (
    <div className="space-y-3">
      ...
      <CylindricalShellExternalCalculator handbook={data} />
    </div>
  );
}
