...
export function CalculatorHandbookPage({
  children,
}: {
  children: (handbook: SteelHandbook) => ReactNode;
}) {
  ...
  return (
    <div className="space-y-3">
      <Link to="/calculators" className="inline-flex items-center gap-1.5 text-base text-[var(--color-primary)] hover:underline">
